...
export function WaveSurfer () {
  var WaveSurfer = {
    ...
    init: function (a) {
      ...
      this.container = typeof a.container === 'string' ? document.querySelector(this.params.container) : this.params.container,
      !this.container) { throw new Error('Container element not found') }
      if (this.params.mediaContainer == null ? this.mediaContainer = this.container : typeof this.params.mediaContainer === 'string' ? this.mediaContainer = document.querySelector(this.params.mediaContainer) : this.mediaContainer = this.params.mediaContainer,
    ...
    createBackend: function () {
      ...
      this.params.backend == 'AudioElement' && (this.params.backend = 'MediaElement'),
      // eslint-disable-next-line eqeqeq
      this.params.backend != 'WebAudio' || WaveSurfer.WebAudio.supportsWebAudio() || (this.params.backend = 'MediaElement'),
  ...
  WaveSurfer.util = {
    ...
    ajax: function (a) {
      ...
      c.addEventListener('load', function (a) {
        ...
        b.fireEvent('load', a),
        c.status == 200 || c.status == 206 ? b.fireEvent('success', c.response, a) : b.fireEvent('error', a)
      }),
 ...
 for (var h = e[g] = [], i = this.buffer.getChannelData(g), j = 0; a > j; j++) {
    ...
    seekTo: function (a, b) {
      ...
      a == null && (a = this.getCurrentTime(),
      a >= this.getDuration() && (a = 0)),
      b == null && (b = this.getDuration()),
  ...
  WaveSurfer.util.extend(WaveSurfer.MediaElement, {
    ...
    seekTo: function (a) {
      a != null && (this.media.currentTime = a),
      this.clearPlayEnd()
    },
    play: function (a, b) {
      this.seekTo(a),
 ...
 return this.setHeight(c.length * this.params.height * this.params.pixelRatio),
      ...
      var e = 0.5 / this.params.pixelRatio,
       f = this.width,
    ...
    drawWave: function (a, b) {
      ...
      var h = 0.5 / this.params.pixelRatio,
